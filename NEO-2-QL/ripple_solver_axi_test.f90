...
!
  ...
  real(kind=dp),   DIMENSION(:,:,:), ALLOCATABLE :: source_vector_all
...
!
  ...
  real(kind=dp), DIMENSION(0:lag,0:leg,ibeg:iend,0:num_spec-1) :: scalprod_pleg
  real(kind=dp), DIMENSION(0:lag,0:leg,ibeg:iend,0:num_spec-1) :: scalprod_pleg_tmp
  ! Species index
