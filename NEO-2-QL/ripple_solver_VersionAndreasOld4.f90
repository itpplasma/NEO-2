...
!
  !! Modifications by Andreas F. Martitsch (03.12.2013)
  ! Include dependency on poloidal mode number (m_theta)
  INTEGER :: m_phi, m_theta
  !! End Modifications by Andreas F. Martitsch (03.12.2013)
  ...
  NAMELIST /ntv_extra_input/ &
       bnoverb0_Val,swHatOmegaEOrEField,hatOmegaEOrEField,hatOmegaB,m_phi,m_theta
  !! End Modifications by Andreas F. Martitsch (03.12.2013)
...
!! Modification by Andreas F. Martitsch (03.12.2013)
!bnoverb0=(1.d0,0.d0)
...
! not the field-aligned one!)
dbnoverb0_dtheta=imun*m_theta*bnoverb0
!! End Modification by Andreas F. Martitsch (03.12.2013)
!
...
!! Modification by Andreas F. Martitsch (03.12.2013)
!! Block commented out --> Electric field is already set to a constant
