...
!
  ...
  DOUBLE COMPLEX :: denom_energ, coef_energ, denom_dens, coef_dens             !<=sergei 08.08.19
  DOUBLE COMPLEX, DIMENSION(:),   ALLOCATABLE :: energvec_bra, energvec_ket
  DOUBLE COMPLEX, DIMENSION(:),   ALLOCATABLE :: densvec_bra, densvec_ket      !<=sergei 08.08.19
...
!
    DOUBLE COMPLEX, DIMENSION(n_2d_size) :: fmaxw
!
    DO istep=ibeg,iend
!
      npassing=npl(istep)
...
!
    integer :: k,m
    DOUBLE COMPLEX, DIMENSION(n_2d_size)      :: source
