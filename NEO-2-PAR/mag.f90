...
END SUBROUTINE mag
! ------------------------------------------------------------------------
SUBROUTINE mag_real(x,bmod,sqrtg,bder,hcovar,hctrvr,hcoder,hctder)
  !
...
!!$! ------------------------------------------------------------------------
!
SUBROUTINE mag_homogeneous(x,bmod,sqrtg,bder,hcovar,hctrvr,hcoder,hctder)
  ...
  !
  RETURN
END SUBROUTINE mag_homogeneous

SUBROUTINE mag_legendre(x,bmod,sqrtg,bder,hcovar,hctrvr,hcurl)
  !
