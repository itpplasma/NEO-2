...
! Plotting:
  ...
  if(iplot.eq.1) then
    ...
    if (prop_fileformat .eq. 1) then
       ...
       call h5_add(h5id_sizeplot, 'nplp1', nplp1, comment='number of eta levels')
       call h5_add(h5id_sizeplot, 'icounter', icounter, comment='number of phi points')
