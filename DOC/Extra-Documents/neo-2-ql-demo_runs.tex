...
The python module \vv{scan_nonhdf5_tools} provides two other useful
...
append_list_unsucessful_runs('./', 'es_*', 'neo2_multispecies_out.h5', 'submit_failed.template', 'submit_failed')
\end{verbatim}
Note that for this to work, the queue command in the template has have a
