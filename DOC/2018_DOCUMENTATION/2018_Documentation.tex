...
Example can be found in \vv{DOC/example_bg_field.bc} and \vv{DOC/example_pert_field.bc}
The Boozer files for ECCD runs are
located here: \vv{NEO2DATAPATH/Interface/Boozer/}.
...
\vv{NEO2DATAPATH/Interface/Profiles/w7x-m111-b3-i1/prf.txt}.
