...
\begin{equation*}
	\tilde{f}^c_{mn} \equiv f^c_{mn} + f^c_{-m-n} \text{ for } m \geq 0
\end{equation*}
\begin{equation*}
	\tilde{f}^s_{mn} \equiv f^s_{mn} - f^s_{-m-n} \text{ for } m \geq 0
\end{equation*}

or

\begin{equation*}
	\hat{f}^c_{mn} \equiv f^c_{mn} + f^c_{-m-n} \text{ for } n \geq 0
\end{equation*}
\begin{equation*}
	\hat{f}^s_{mn} \equiv f^s_{mn} - f^s_{-m-n} \text{ for } n \geq 0
\end{equation*}
