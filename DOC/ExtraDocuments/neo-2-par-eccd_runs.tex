...
\begin{itemize}
 ...
 \begin{itemize}
  ...
  \item 10: Cubic Splines generated from a $y_m = (0, 0, \ldots, 1, \ldots, 0)$ grid.
...
\vv{/temp} folder e.g. your run folder, as Condor can only access scripts that are located on AFS, which mostly
...
See \vv{https://gitlab.tugraz.at/plasma/info} for further information.
