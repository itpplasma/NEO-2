...
\section{Reduced single-ion NEO-2 limit}
...
\begin{tabular}{lrrr}
  ...
  Reduced single-ion ($k_{ii}$) & $-0.685$ & $-1.697$ & $9$--$12\%$ \\
  Level 2 ($k_{ii}$)            & $-0.662$ & $-1.666$ & ${\sim}8\%$ \\
  Level 1                       & $-1.883$ & $-3.284$ & ${\sim}3\times$ \\
  ...
  Level 2 ($V^\ph B_\tht$, $k\!=\!{-}1.17$) & $-7.617$ & $-8.173$ & wrong \\
  \bottomrule
\end{tabular}
\end{center}
