...
def write_axisymmetric_quantities(infilename:str, outfilename:str):
  ...
  try:
    h['Gamma_NA_spec']
    header = "!               s             aiota          av_nabla_stor          Bref [G]                Er   MtOvR electrons   MtOvR deuterium D13  D23 D31 D32\n"
    er_available = True
  except KeyError:
    er_available = False
    header = "!               s             aiota          av_nabla_stor          Bref [G]\n"
    ...
    for k in range(h['Bref'].size):
      if er_available:
        outfile.write("{: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e} {: 16.10e}  {: 16.10e}\n".format(
          h['boozer_s'][k], h['aiota'][k], h['av_nabla_stor'][k], h['Bref'][k],
