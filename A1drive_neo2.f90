...
!
  ...
  integer :: i,m,nprop,iprop,iphi,iphi0
!
  double precision :: theta,phi,alam,collpar,eps
...
!
  ...
  OPEN(iunit,file='NEO2_DATA/phi_mesh.'                       &
       //trim(adjustl(propname))//'.dat')
  OPEN(iunit_p,form='unformatted',file='NEO2_DATA/dentf_p.'   &
       //trim(adjustl(propname))//'.dat')
  OPEN(iunit_m,form='unformatted',file='NEO2_DATA/dentf_m.'   &
       //trim(adjustl(propname))//'.dat')
  do iphi=1,nphi
