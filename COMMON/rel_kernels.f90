...
MODULE rel_kernels_mod
  ...
  real(kind=dp), DIMENSION(:,:), ALLOCATABLE :: coefleg,coefdleg,weights
...
!
  ...
  real(kind=dp), DIMENSION(:),   ALLOCATABLE :: xnode
  real(kind=dp), DIMENSION(:,:), ALLOCATABLE :: amat,bvec,wint
...
subroutine rel_kernels(leg,z_in,zp_in,R_11,R_10,R_01,R_00)
  ...
  integer :: i,j,n,leg
  real(kind=dp) :: z,zp,R_11,R_10,R_01,R_00,z_in,zp_in
  real(kind=dp) :: z2,zp2,gam,gamp,pleg,dpleg,ggpm1,dyovsq,plegllp1,gz_10,gz_01
  real(kind=dp) :: ymin,ymax,hy,y,y2,r,xi,cxi0,cxi1,sqrp1,onemxi2,comfac,dfllp1
